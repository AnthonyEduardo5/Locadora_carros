            ...
            <template v-slot:conteudo>
                <div class="form-group">
                    <input-container-component titulo="Nome da marca" id="novoNome" idHelp="novoNomeHelp" texto-ajuda="informe o nome da marca">
                        <input type="type" class="form-control" id="novoNome" aria-describedby="novoNomeHelp" placeholder="Nome da marca" v-model="nomeMarca">
                    </input-container-component>
                    {{ nomeMarca }}
                </div>
        ...
        <modal-component id="modalMarcaVisualizar" titulo="Visualizar marca">
            ...
            <template v-slot:conteudo>
                ...
                <input-container-component titulo="Imagem" v-if="$store.state.item.imagem">
                    <img type="text" classe="form-control" :src="'storage/'+$store.state.item.imagem">
                </input-container-component>
    ...
    export default {
        ...
        methods: {
            ...
            carregarLista() {
                ...
                let url = this.urlBase + '?' + this.urlPaginacao + this.ulrFiltro
